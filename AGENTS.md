...
- WDIO assertions determine the job result. The default-branch `workflow_run` publisher validates Windows/Linux evidence and publishes the current PR report under GitHub Pages. The PR owner inspects the report and records human acceptance before merge.
